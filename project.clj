(defproject sjlibrary "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "sjlibrary.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main sjlibrary.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "sjlibrary.core/on-figwheel-reload"}

                :compiler {:main sjlibrary.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/sjlibrary.js"
